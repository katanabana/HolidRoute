...
PROVIDERS_TO_MODELS = {
    ...
    Provider.HuggingFace: "gpt-4o",
    Provider.MetaAI: "gpt-4o",
    Provider.OpenRouter: "gpt-4o",
    Provider.PerplexityLabs: "gpt-4o",
    Provider.Pi: "gpt-4o",
    Provider.Replicate: "gpt-4o",
    Provider.ThebApi: "gpt-4o",
    Provider.WhiteRabbitNeo: "gpt-4o",
}
